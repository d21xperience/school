...
<template>
    ...
    <div class="card">
        <DataTable v-model:selection="selectedGtk" :value="response_data.rows" selectionMode="single"
            ...
            <Column field="tanggal_masuk_sekolah" header="Tgl. Masuk Sekolah" class="text-sm"></Column>
            <Column field="ket_keluar" header="Keluar Karena" class="text-sm"></Column>
