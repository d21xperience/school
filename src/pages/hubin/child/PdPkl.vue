...
<template>
    ...
    <div class="card">
        <DataTable v-model:selection="selectedMou" :value="response_data.rows" selectionMode="single" dataKey="mou_id"
            ...
            <Column field="nama_dudi" header="Nama PD" class="text-sm"></Column>
            <Column field="nama_bidang_usaha" header="Kelas" class="text-sm"></Column>
            <Column field="judul_mou" header="Pengawas" class="text-sm"></Column>
            <Column field="nama_dudi" header="Nama Dudi" class="text-sm"></Column>
