...
const response_data = computed(() => store.getters.dudi)
onMounted(() => {
    store.dispatch("getDudi")
})
...
const ubah = () => {
    console.log(selectedDudi.value)
}
const cek = ref(true)
const dt = ref();
const exportCSV = () => {
...
<template>
    ...
    <div class="card">
        <DataTable v-model:selection="selectedDudi" :value="response_data.rows" selectionMode="single" dataKey="dudi_id"
            ...
            <Column field="bidang_usaha_id_str" header="Bidang Usaha" class="text-sm"></Column>
            <Column field="alamat_jalan" header="Alamat Jalan" class="text-sm">
            </Column>
            <Column field="kode_wilayah_str" header="Kecamatan" class="text-sm"></Column>
