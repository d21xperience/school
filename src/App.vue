...
<template>
  <header class='flex shadow-sm py-3 px-4 sm:px-10 bg-white min-h-[70px] tracking-wide relative z-50'>
    <div class='flex flex-wrap items-center justify-between font-[sans-serif] lg:gap-y-4 gap-y-6 gap-x-4 w-full'>
      <router-link to="/">
        <div class="max-w-[90px]">
          <div>
            <span class="font-bold text-2xl">T.U. SP</span>
      ...
      <div id="collapseMenu"
        ...
        <ul
          ...
          <li class='a-link'>
            <router-link to='/' class='text-black block text-[15px]' activeClass="a-link-active">Home</router-link>
          </li>
          <li class='a-link'>
            <router-link to='/sarpras' class='text-black block text-[15px]'
              activeClass="a-link-active">Sarpras</router-link>
          </li>
          <li class='a-link'>
            <router-link to='/kepegawaian' class='text-black block text-[15px]'
              activeClass="a-link-active">Kepegawaian</router-link>
          </li>
          <li class='a-link'>
            <router-link to="/kurikulum" class='text-black block text-[15px]'
              activeClass="a-link-active">Kurikulum</router-link>
          </li>

          <li class='a-link'>
            <router-link to='/kesiswaan' class='text-black block text-[15px]'
              activeClass="a-link-active">Kesiswaan</router-link>
          </li>
          <li class='a-link'>
            <router-link to='/hubin' class='text-black block text-[15px]'
              activeClass="a-link-active">Hubin</router-link>
          </li>
          <li class='a-link'>
            <router-link to="/surat-menyurat" class='text-black block text-[15px]' activeClass="a-link-active">Surat
              Menyurat</router-link>
          </li>

          <li class='a-link'>
            <router-link to='/admin' class='text-black block text-[15px]'
              activeClass="a-link-active">Admin</router-link>
          </li>
          <!-- <li
